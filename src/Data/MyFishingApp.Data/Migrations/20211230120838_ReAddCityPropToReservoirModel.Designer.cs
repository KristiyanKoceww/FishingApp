...
namespace MyFishingApp.Data.Migrations
{
    ...
    [Migration("20211230120838_ReAddCityPropToReservoirModel")]
    partial class ReAddCityPropToReservoirModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFishingApp.Data.Models.ImageUrls", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MyFishingApp.Data.Models.RefreshToken", b =>
                {
            ...
            modelBuilder.Entity("MyFishingApp.Data.Models.ImageUrls", b =>
                {
                    b.HasOne("MyFishingApp.Data.Models.Fish", null)
                        .WithMany("ImageUrls")
                    ...
                    b.HasOne("MyFishingApp.Data.Models.Post", null)
                        .WithMany("ImageUrls")
                        .HasForeignKey("PostId");
