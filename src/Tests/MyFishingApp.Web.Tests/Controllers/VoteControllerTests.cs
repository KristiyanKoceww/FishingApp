namespace MyFishingApp.Web.Tests.Controllers
{
    ...
    public class VoteControllerTests
    {
        ...
        .Instance()
        .WithData(new ApplicationUser() { Id = "1", Age = 17, FirstName = "User", MiddleName = "user", LastName = "user", Email = "user@gmail.com", Gender = Gender.Female, UserName = "userName", PhoneNumber = "3598534421" })
       ...
       .Ok();
        ...
        .Instance()
        .WithData(new ApplicationUser() { Id = "1", Age = 17, FirstName = "User", MiddleName = "user", LastName = "user", Email = "user@gmail.com", Gender = Gender.Female, UserName = "userName", PhoneNumber = "3598534421" })
        .WithData(new ApplicationUser() { Id = "2", Age = 17, FirstName = "User", MiddleName = "user", LastName = "user", Email = "user@gmail.com", Gender = Gender.Female, UserName = "userName", PhoneNumber = "3598534421" })
        .WithData(new Post() { Id = 1, UserId = "1", Content = "content", Title = "title" })
        .WithData(new Vote() { Id = 1, PostId = 1, Type = VoteType.Neutral, UserId = "1" })
